...
final class EmbedFilterHelper
{
    ...
    {
        return function (FilterBuilderExecuterInterface $qbe) use ($name, $column): void {
            ...
            $qbe->addOnce($field, $name, function (QueryBuilder $qb, $alias, $joinAlias) use ($column): void {
